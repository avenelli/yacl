...
extern void YACL_ZpEccAdd(DEF_PARAM)
{
  LlZpEccAdd_C(YACL_ZPECCADD(pu1PointABase),
               YACL_ZPECCADD(pu1PointBBase),
               YACL_ZPECCADD(u2ModLength),
               YACL_ZPECCADD(pu1ModBase),
               YACL_ZPECCADD(pu1Cns),
               YACL_ZPECCADD(pu1Workspace));
  return;
}
